...
const plugins = [{ enforce: "pre" as const, ...mdxPlugin }, react(), tailwindcss(), jsxLocPlugin(), vitePluginManusRuntime(), vitePluginManusDebugCollector(), vitePluginStorageProxy()];
